...
class CartPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isAvailableCart = cartController.carts.isNotEmpty;
    return Scaffold(
      bottomNavigationBar: isAvailableCart
                    ...
                    child: MediaQuery.removePadding(
                        ...
                        child:
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (_, index) {
                                var product =
                                    productController.allCartItems[index];
